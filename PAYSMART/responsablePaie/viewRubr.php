...
<br><br>
       ...
       &nbsp  &nbsp  &nbsp  &nbsp  &nbsp &nbsp  &nbsp  &nbsp  &nbsp  &nbsp
       &nbsp  &nbsp  &nbsp  &nbsp  &nbsp &nbsp  &nbsp  &nbsp  &nbsp  &nbsp <a href="insertRubrique.php" class="button">Ajouter rubrique</a>
        </td>
...
if (isset($_POST['search'])) 
{
    ...
    $query = "SELECT * FROM rubrique WHERE `$selectedOption` LIKE '%$filtervalues%'";
...
if ($query_run) {
    ...
    <a href="updateRubrique.php?id=<?php echo $r['idRubrique']; ?>" class="m-2">
    ...
    <div class="confirmation-alert" id="confirmationModal<?php echo $r['idRubrique']; ?>" style="color:white;background: #0a5275">
        ...
        <div class="btn-wrapper">
            ...
            <a href="deleteRubrique.php?id=<?php echo $r['idRubrique']; ?>">
